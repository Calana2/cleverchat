...
const ROOM_TAG = "advice"
const ROOM_FIRST_MESSAGE = 
`Bienvenido a la sección "Consejos", encontrarás criterios prácticos y reflexiones para mejorar tu día a día. No dudes en aportar tus propios consejos y ayudar a otros en su camino.`
